...
def showStatsOptions():
    ...
    print('3) See total spaces used any of the 14 days \n')
    print('4) See total accesible spaces used in whole period (14 days) \n')
    print('5) See total general spaces used in whole period (14 days) \n')
    print('6) See total spaces used in whole period (14 days) \n')
    ...
    if userInput == '1':
        ...
        totalSpacesOnSingleDay()
    elif userInput == '4':
        wholePeriodAccesibleSpaces()
    elif userInput == '5':
...
def showSingleDayGeneralStats():
    requestedDay = int(input('Enter the day you want to see the general space stats: \n'))
...
def totalSpacesOnSingleDay():
    requestedDay = int(input('Enter the day you want to see the total space stats: \n'))
    totalSpaceOccupied = 0

    for booking in bookings:
        if booking["requestedDay"] == requestedDay:
            totalSpaceOccupied += 1

    print('Total spaces used: ' +
          str(totalSpaceOccupied))

def wholePeriodAccesibleSpaces():
    totalAccessbleSpaces = 0

    for booking in bookings:
        if booking["parkingNumber"] <= 5:
            totalAccessbleSpaces += 1

    print('Total accessible spaces used in whole period (14 days): ' +
          str(totalAccessbleSpaces))
...
def wholePeriodGeneralSpaces():
    ...
    print('Total general spaces used in whole period (14 days): ' +
...
def wholePeriodTotalSpaces():
    ...
    print('Total spaces used in whole period (14 days): ' +
          str(totalSpaces))
